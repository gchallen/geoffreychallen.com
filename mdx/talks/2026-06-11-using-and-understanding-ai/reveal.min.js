...
!(function (e, t) {
  ...
  const e = (e, t) => {
    ...
    c = { mp4: "video/mp4", m4a: "video/mp4", ogv: "video/ogg", mpeg: "video/mpeg", webm: "video/webm" },
    h = navigator.userAgent,
    u = /(iphone|ipod|ipad|android)/gi.test(h) || ("MacIntel" === navigator.platform && navigator.maxTouchPoints > 1),
    g = /android/gi.test(h)
  var v = (function (e) {
    if (e) {
      var t = function (e) {
        ...
        b = function (e) {
          e.observeMutations &&
            ((e.observer = new MutationObserver(p(e, 1))), e.observer.observe(e.element, e.observeMutations))
        },
        w = {
          minSize: 16,
          maxSize: 512,
  ...
  class p {
    ...
    layout(e) {
      Array.from(e.querySelectorAll(".r-fit-text")).forEach((e) => {
        v(e, { minSize: 24, maxSize: 0.8 * this.Reveal.getConfig().height, observeMutations: !1, observeWindow: !1 })
      })
    }
    unload(e) {
  ...
  class E {
    ...
    hide() {
      this.isVisible() &&
        (this.element.remove(), (this.jumpInput.value = ""), clearTimeout(this.jumpTimeout), delete this.jumpTimeout)
    }
    isVisible() {
      ...
      if (
        (Array.from(this.element.childNodes).forEach((i, s) => {
          ;(i.classList.remove("past", "present", "future"),
            s < a.h ? i.classList.add(r) : s > a.h ? i.classList.add(o) : (i.classList.add("present"), (n = i)),
            (e || s === a.h) &&
        ...
        this.previousBackground && !this.previousBackground.closest("body") && (this.previousBackground = null),
  ...
  class k {
    ...
    run(e, t) {
      ...
      if (
        ...
        if (
          ...
          "false" !== t.dataset.autoAnimateUnmatched && !0 === this.Reveal.getConfig().autoAnimateUnmatched)
        ) {
    ...
    autoAnimateElements(e, t, i, s, a) {
      ...
      if ((t.classList.contains("fragment") && delete o.styles.opacity, !1 !== i.translate || !1 !== i.scale)) {
          ...
          ;("string" == typeof t && (t = { property: t }),
            void 0 !== t.from && "from" === e
              ...
              : void 0 !== t.to && "to" === e
                ...
                : ("line-height" === t.property && (i = parseFloat(n["line-height"]) / parseFloat(n["font-size"])),
  ...
  class L {
      ...
      const d = (e, t, i, n) => {
        ...
        ;(o.appendChild(e),
          ...
          e.slideBackgroundElement &&
            (e.slideBackgroundElement.remove("past", "future"), o.insertBefore(e.slideBackgroundElement, e)),
          (l = e))
      }
      ;(i.forEach((e, t) => {
    ...
    syncPages() {
      ...
      ;((this.scrollTriggerHeight = s ? n : a),
        ...
        (this.viewportElement.style.scrollSnapType = "string" == typeof e.scrollSnap ? `y ${e.scrollSnap}` : ""),
        (this.slideTriggers = []))
        ...
        this.slideTriggers.push(
          ...Array.from(e.autoAnimateElements).map((t, i) => {
            ...
            return (
              ...
              { page: s, activate: () => this.activatePage(s), deactivate: () => this.deactivatePage(s) }
            )
          }),
        )
    }
        ...
        s > 6
          ? this.slideTriggers.forEach((e) => {
              ...
              ;((t.progressBarSlide = document.createElement("div")),
                ...
                (t.progressBarSlide.style.height = (e.range[1] - e.range[0]) * this.progressBarHeight - a + "px"),
      ...
      ;(i.forEach(function (i, a) {
        if (!1 === i.classList.contains("stack")) {
          ...
          ;((m = Math.min(m, e.pdfMaxPagesPerSlide)),
            ((1 === m && e.center) || i.classList.contains("center")) && (c = Math.max((r - v) / 2, 0)))
    ...
    update(e, t, i = this.Reveal.getCurrentSlide()) {
      ...
      if (i && this.Reveal.getConfig().fragments && (t = t || this.sort(i.querySelectorAll(".fragment"))).length) {
        ...
        ;(Array.from(t).forEach((t, i) => {
          if (
            (t.hasAttribute("data-fragment-index") && (i = parseInt(t.getAttribute("data-fragment-index"), 10)),
            (a = Math.max(a, i)),
            i <= e)
          ) {
            ...
            ;(t.classList.add("visible"),
              ...
              a || (s.shown.push(t), this.Reveal.dispatchEvent({ target: t, type: "visible", bubbles: !1 })))
          } else {
      ...
      return (
        s.hidden.length &&
          this.Reveal.dispatchEvent({ type: "fragmenthidden", data: { fragment: s.hidden[0], fragments: s.hidden } }),
        s.shown.length &&
          this.Reveal.dispatchEvent({ type: "fragmentshown", data: { fragment: s.shown[0], fragments: s.shown } }),
        s
      )
    }
  ...
  class T {
    ...
    onDocumentKeyDown(e) {
      ...
      let a = document.activeElement && !0 === document.activeElement.isContentEditable,
        ...
        l =
          !((-1 !== [32, 37, 38, 39, 40, 63, 78, 80, 191].indexOf(e.keyCode) && e.shiftKey) || e.altKey) &&
      ...
      let h = "linear" === t.navigationMode || !this.Reveal.hasHorizontalSlides() || !this.Reveal.hasVerticalSlides(),
        u = !1
      if ("object" == typeof t.keyboard)
        for (d in t.keyboard)
          if (parseInt(d, 10) === i) {
  ...
  class N {
    ...
    getIndicesFromHash(e = window.location.hash, t = {}) {
      ...
      if (/^[0-9]*$/.test(s[0]) || !i.length) {
        ...
        return (e.fragmentInURL && ((i = parseInt(s[2], 10)), isNaN(i) && (i = void 0)), { h: n, v: r, f: i })
      }
      {
        let e, t
        ;/\/[-\d]+$/g.test(i) &&
  ...
  class I {
    ...
    configure(e, t) {
      ;((this.element.style.display =
        e.controls && ("speaker-only" !== e.controls || this.Reveal.isSpeakerNotes()) ? "block" : "none"),
    ...
    unbind() {
      ;["touchstart", "click"].forEach((e) => {
        ;(this.controlsLeft.forEach((t) => t.removeEventListener(e, this.onNavigateLeftClicked, !1)),
          ...
          this.controlsFullscreen.forEach((t) => t.removeEventListener(e, this.onEnterFullscreen, !1)))
      })
    }
    update() {
  ...
  class F {
    ...
    update() {
      ...
      const e = this.Reveal.getSlidesElement().querySelectorAll(this.iframeTriggerSelector).length > 0,
  ...
  class U {
    ...
    updateVisibility() {
      this.Reveal.getConfig().showNotes && this.hasNotes() && !this.Reveal.isScrollView() && !this.Reveal.isPrintView()
  ...
  function $(n, o) {
    ...
    function Re(t) {
      ...
      ;(_.wrapper.classList.remove(s.transition),
        ...
        _.viewport.style.setProperty("--slide-width", "string" == typeof A.width ? A.width : A.width + "px"),
        _.viewport.style.setProperty("--slide-height", "string" == typeof A.height ? A.height : A.height + "px"),
        A.shuffle && Ye(),
        ...
        a > 1 &&
          ...
          ((S = new W(_.wrapper, () => Math.min(Math.max((Date.now() - Z) / G, 0), 1))), S.on("click", Lt), (ee = !1)),
    ...
    function Te(e) {
      Pe({ type: "slidechanged", data: { indexh: c, indexv: h, previousSlide: g, currentSlide: v, origin: e } })
    }
    function Ne(t, i) {
    ...
    function Ie() {
      if (_.wrapper && !oe.isActive()) {
        ...
        if (!A.disableLayout) {
          u && !A.embedded && document.documentElement.style.setProperty("--vh", 0.01 * window.innerHeight + "px")
    ...
    function Ke(e, i, s, a) {
      ...
      ;(u &&
        ...
        v &&
        !de.isActive() &&
        ((J = "running"), (b = $e(g, v, l, d)), b && _.slides.classList.add("disable-slide-transitions")),
        Qe(),
        Ie(),
        de.isActive() && de.update(),
        void 0 !== s && le.goto(s),
    ...
    function Xe() {
      ;(ke(),
        ...
        !1 === A.autoPlayMedia ? te.stopEmbeddedContent(v, { unloadIframes: !1 }) : te.startEmbeddedContent(v),
      ...
      if (a && void 0 !== c) {
        ...
        for (let r = 0; r < a; r++) {
          ...
          if (
            ...
            for (let s = 0; s < d; s++) {
              let a = l[s]
              ;((i = r === (c || 0) ? Math.abs((h || 0) - s) : Math.abs(s - t)), e + i < n ? te.load(a) : te.unload(a))
            }
          }
        }
        ;(rt() ? _.wrapper.classList.add("has-vertical-slides") : _.wrapper.classList.remove("has-vertical-slides"),
          nt() ? _.wrapper.classList.add("has-horizontal-slides") : _.wrapper.classList.remove("has-horizontal-slides"))
      }
    }
    function Ze({ includeFragments: e = !1 } = {}) {
      ...
      if (
        (A.loop && (t.length > 1 && ((s.left = !0), (s.right = !0)), i.length > 1 && ((s.up = !0), (s.down = !0))),
        t.length > 1 && "linear" === A.navigationMode && ((s.right = s.right || s.down), (s.left = s.left || s.up)),
        !0 === e)
      ) {
    ...
    function dt() {
      let e = tt()
      return { indexh: e.h, indexv: e.v, indexf: e.f, paused: je(), overview: de.isActive(), ...me.getState() }
    }
    function ct() {
    ...
    function ut() {
      G && !ee && ((ee = !0), Pe({ type: "autoslidepaused" }), clearTimeout(Q), S && S.setPlaying(!1))
    }
    function gt() {
    ...
    function vt({ skipFragments: e = !1 } = {}) {
      ...
      A.rtl
        ? (de.isActive() || e || !1 === le.next()) && Ze().left && Ke(c + 1, "grid" === A.navigationMode ? h : void 0)
        : (de.isActive() || e || !1 === le.prev()) && Ze().left && Ke(c - 1, "grid" === A.navigationMode ? h : void 0)
    }
    function pt({ skipFragments: e = !1 } = {}) {
      if (((O.hasNavigatedHorizontally = !0), re.isActive())) return re.next()
      A.rtl
        ? (de.isActive() || e || !1 === le.prev()) && Ze().right && Ke(c - 1, "grid" === A.navigationMode ? h : void 0)
        : (de.isActive() || e || !1 === le.next()) && Ze().right && Ke(c + 1, "grid" === A.navigationMode ? h : void 0)
    }
    ...
    function bt({ skipFragments: e = !1 } = {}) {
      if (((O.hasNavigatedHorizontally = !0), (O.hasNavigatedVertically = !0), re.isActive())) return re.next()
      if (e || !1 === le.next()) {
        let t = Ze()
        ;(t.down && t.right && A.loop && ze() && (t.down = !1),
          t.down ? ft({ skipFragments: e }) : A.rtl ? vt({ skipFragments: e }) : pt({ skipFragments: e }))
      }
    }
    function wt(e) {
      let t = e.data
    ...
    function Et(e) {
      "running" === J &&
        ...
        ((J = "idle"),
        Pe({ type: "slidetransitionend", data: { indexh: c, indexv: h, previousSlide: g, currentSlide: v } }))
    }
    function St(e) {
        ...
        return (
          ...
          (function () {
            !0 === A.embedded
              ...
              : ((_.viewport = document.body), document.documentElement.classList.add("reveal-full-page"))
      ...
      destroy: function () {
        ;((H = !1),
          !1 !== q &&
            ...
            _.wrapper.classList.remove("ready", "center", "has-horizontal-slides", "has-vertical-slides"),
